...
folder are mapped to the application's root namespace, 'krf_new'. This is set in
`"app.json"`:
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'krf_new' in the same way
as `"krf_new/sass/src"`.
